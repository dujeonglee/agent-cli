...
> 최종 업데이트: 2026-03-22
> 버전: 2.0.0-dev
> 총 소스: 4,482 LOC (41 Python 파일) + 3,602 LOC 테스트 (21 파일)
> 총 테스트: 266 유닛 + 42 통합 = 308개
...
│   ├── compat.py            (305)  ModelCapabilities + 프로브 감지 + 자동 저장
