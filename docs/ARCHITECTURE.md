...
**설정:**
- `AGENT_CLI_LLM_RETRY_ATTEMPTS` (기본 10, 최초 포함 총 시도 횟수; 0/음수는 1로 clamp) — Timeout / ConnectionError 전용
- `AGENT_CLI_LLM_5XX_RETRY_ATTEMPTS` (기본 3, 최초 포함; 0/음수는 1로 clamp) — 502/503/504 전용, `RETRY_DELAY` 공용
- `AGENT_CLI_LLM_RETRY_DELAY` (기본 1.0초, 네트워크 에러·5xx 공용)
