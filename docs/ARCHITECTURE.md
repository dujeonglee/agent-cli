...
│
├── tools/                          도구 시스템
│   ├── __init__.py          (39)   TOOLS dict + execute_tool() 디스패처
│   ├── registry.py          (262)  스키마 정의, 검증, API 형식 변환
│   ├── read_file.py         (70)   파일 읽기 + hashline 포맷팅
│   ├── write_file.py        (17)   파일 생성
