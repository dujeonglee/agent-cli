...
│       └── style.css        (~740) chat UI 스타일 — 가독성 우선, 모바일 폴백 단일 컬럼. 메시지/카드 색상, 입력창 sticky, Prompt Inspector 드로어, observer 배너·권한-요청 버튼·제어 팝업/토스트 등.
