...
- **워크스페이스 경로 복사 (📋)**: 상단 info bar 의 workspace 경로 옆 📋 버튼을 클릭하면 전체 경로가 클립보드로 복사됩니다 (LAN http 접속에서도 동작 — insecure context 폴백 내장, 복사 후 1초간 ✓ 표시).
